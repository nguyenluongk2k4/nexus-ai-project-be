...
Adds subscription_tier to users table and creates subscription_plans table
"""
...
async def run_migration():
    print("🚀 Running Subscription Plans Migration...")
    ...
    async with engine.begin() as conn:
        ...
        """))
        print("   ✅ Subscription columns added")
        ...
        """))
        print("   ✅ Sample plans inserted")
        
        # 4. Create subscription_transactions table
        print("📦 Creating subscription_transactions table...")
        await conn.execute(text("""
        ...
        """))
        print("   ✅ subscription_transactions table created")
