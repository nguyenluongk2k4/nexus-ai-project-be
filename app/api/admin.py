...
from app.deps import get_skill_service, get_sync_service
...
@router.get(
    ...
    description="Trả về tất cả templates đang active"
)
...
@router.post(
    ...
    description="Tạo một template mới (ví dụ: Frontend Roadmap, Backend Roadmap)"
)
...
@router.post(
    ...
    description="Tạo node mới và tự động sync vào ChromaDB cho search"
)
async def create_node(
    ...
    Tạo skill node mới.
    - Lưu vào PostgreSQL
    - Tự động sync vào ChromaDB cho AI search
    """
...
@router.put(
    ...
    description="Cập nhật node và re-sync ChromaDB"
)
async def update_node(
    ...
    Cập nhật skill node.
    - Update PostgreSQL
    - Re-sync ChromaDB (xóa cũ, thêm mới)
    """
...
@router.delete(
    ...
    description="Xóa node khỏi cả PostgreSQL và ChromaDB"
)
...
@router.post(
    ...
    description="Xóa toàn bộ ChromaDB và rebuild từ PostgreSQL"
)
async def rebuild_index(
    ...
    Dùng khi:
    - ChromaDB bị corrupt
    - Cần re-index sau khi đổi embedding model
    """
    # Get all skills from PostgreSQL
